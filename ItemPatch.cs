...
namespace ColorfulGel
{
    static class ItemPatch
    {
        ...
        private static bool Item_IsNotTheSameAs(On.Terraria.Item.orig_IsNotTheSameAs orig, Item self, Item compareItem)
        {
            if (self.color == default || compareItem.color == default) return orig(self, compareItem);
            return orig(self, compareItem) && self.color == compareItem.color;
